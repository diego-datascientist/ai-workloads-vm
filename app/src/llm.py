...
# def get_embeddings_nim(text: str) -> Any: # embedding using nvidia embedding model
#     """
#     Generates embeddings for the given text using Deployed Nvidia embedding model.
...
#         Any: The embedding vector.
#     """
#     document_embedder = NVIDIAEmbeddings(model=EMBEDDING_MODEL_NVIDIA)
#     try:
#         response = client.embeddings.create(
#             input=[text],
#             model=document_embedder
#         )
...
# def chatbot_nims(question: str, context: str, history: str) -> str:
#     """
#     Generates a chatbot response based on the user's question, provided context, and conversation history.
...
#         logger.info("Chatbot response generated successfully.")
#         return client_nims.stream({"input": messages})
#     except Exception as e:
#         logger.error(f"Unexpected error in chatbot function: {e}")
#         raise
